        ...
        .then(data => {
            ...
            function renderCartItems() {
                ...
                items.forEach((item, index) => {
                    ...
                    // Create the subtotal cell with the reset button
                    ...
                    // Create a separate column for the second delete button (with confirmation)
                    const deleteColumn = document.createElement('td');
                    deleteColumn.innerHTML = `<button class="delete-btn2" data-index="${index}">❌</button>`;
            ...
            // Function to handle the reset delete button click (without confirmation)
            ...
            // Function to handle the confirmation delete button click
            function handleDeleteButtonClick2(event) {
                const index = event.target.getAttribute('data-index');
            ...
            cartItemsContainer.addEventListener('click', (event) => {
                ...
                } else if (event.target.classList.contains('delete-btn2')) {
                    handleDeleteButtonClick2(event);
                }
            });
